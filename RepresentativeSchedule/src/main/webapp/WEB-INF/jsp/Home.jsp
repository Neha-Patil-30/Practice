            ...
            <div class="col-sm-6">
                <div class="card text-center">
                    ...
                    <div class="card-block">
                        ...
                        <a href="/viewSchedule"><button type="button" class="btn btn-outline-primary">View Schedule</button></a>
                        <p></p>
                    </div>
                </div>
            </div>
            <div class="col-sm-6">
                <div class="card text-center">
                    ...
                    <div class="card-block">
                        ...
                        <a href="viewDemand.html"><button type="button" class="btn btn-outline-success">Place Demand</button></a>
                        <p></p>
                    </div>
                </div>
            </div>
